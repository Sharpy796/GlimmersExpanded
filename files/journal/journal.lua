...
if(root == entity)then
    ...
    if(journal_open)then
        ComponentSetValue2( interactable_component, "ui_text", "Press $0 to close diary." )
    else
        ComponentSetValue2( interactable_component, "ui_text", "Press $0 to open diary." )
    end
    return
end
...
dofile("mods/GlimmersExpanded/files/journal/entries.lua")

local background_image = "mods/GlimmersExpanded/files/journal/gfx/background_empty.png"
        ...
        if(is_unlocked)then
            if(entry.icon)then
                ...
                if(category == "Materials")then
                    GuiImage(gui, new_id(), 0, 0, "mods/GlimmersExpanded/files/journal/gfx/material_symbol.png", 1, 1, 1, 0)
                elseif(category == "Alchemy")then
                    GuiImage(gui, new_id(), 0, 0, "mods/GlimmersExpanded/files/journal/gfx/alchemy_symbol.png", 1, 1, 1, 0)
                else
                    GuiImage(gui, new_id(), 0, 0, "mods/GlimmersExpanded/files/journal/gfx/unknown_symbol.png", 1, 1, 1, 0)
                end
            end
            ...
            GuiImage(gui, new_id(), 0, 0, "mods/GlimmersExpanded/files/journal/gfx/locked_symbol.png", 1, 1, 1, 0)
