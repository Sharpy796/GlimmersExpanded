...
--     },
-- 	{ -- Make glimmer spells mix with each other
-- 		path    = "data/scripts/projectiles/colour_spell.lua",
-- 		from    = "( comps ~= nil )",
-- 		to      = "( comps ~= nilll )",
-- 	},
...
-- 		path    = "data/scripts/projectiles/colour_spell.lua",
-- 		from    = "( comps ~= nil )",
-- 		to      = "( comps ~= nil and not ModSettingGet('GlimmersExpanded.glimmer_mixing') )",
-- 		unbound	= true,
-- 	},
-- 	{ -- Make glimmer spells mix with each other
-- 		path    = "data/scripts/projectiles/colour_spell.lua",
...
local function patchFiles()
	...
	for i=1, #patches do
		...
		if content ~= nil then
			if patch.unbound ~= nil and patch.unbound == true then
				content = content:gsub(patch.from, patch.to, 6)
			else
